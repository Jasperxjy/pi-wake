...
![npm downloads per day](.github/metrics/downloads.svg)

<sub>Registry download counts (daily refresh, mirror pulls included — the plugin itself is fully local and reports nothing).</sub>
